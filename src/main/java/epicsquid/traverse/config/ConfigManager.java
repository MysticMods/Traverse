...
public class ConfigManager {
  ...
  public static BiomeConfig AUTUMNAL_WOODS = new BiomeConfig("autumnal_woods", 6);
  ...
  public static BiomeConfig HIGH_CONIFEROUS_FOREST = new BiomeConfig("high_coniferous_forest", 3);
  ...
  public static BiomeConfig MINI_JUNGLE = new BiomeConfig("mini_jungle", 3);
  public static BiomeConfig PLAINS_PLATEAU = new BiomeConfig("plains_plateau", 1);
  public static BiomeConfig ROCK_EDGE = new BiomeConfig("rock_edge", 4);
  public static BiomeConfig ROLLING_HILLS = new BiomeConfig("rolling_hills", 6);
  ...
  public static BiomeConfig WOODLANDS = new BiomeConfig("woodlands", 9);
