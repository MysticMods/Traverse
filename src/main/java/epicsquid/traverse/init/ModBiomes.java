...
public class ModBiomes {
  ...
  public static void registerBiomes(RegistryEvent.Register<Biome> event) {
    registerBiome(ARID_HIGHLANDS = k("arid_highlands"), (int) ConfigManager.ARID_HIGHLANDS.weight(), BiomeManager.BiomeType.DESERT, BiomeDictionary.Type.HOT, BiomeDictionary.Type.DRY, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.OVERWORLD);
    ...
    registerBiome(HIGH_CONIFEROUS_FOREST = k("high_coniferous_forest"), (int) ConfigManager.HIGH_CONIFEROUS_FOREST.weight(), BiomeManager.BiomeType.COOL, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.MOUNTAIN, BiomeDictionary.Type.COLD, BiomeDictionary.Type.OVERWORLD);
    ...
    registerBiome(MEADOW = k("meadow"), (int) ConfigManager.MEADOW.weight(), BiomeManager.BiomeType.COOL, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.LUSH, BiomeDictionary.Type.WET, BiomeDictionary.Type.OVERWORLD);
    registerBiome(MINI_JUNGLE = k("mini_jungle"), (int) ConfigManager.MINI_JUNGLE.weight(), BiomeManager.BiomeType.WARM, BiomeDictionary.Type.DENSE, BiomeDictionary.Type.JUNGLE, BiomeDictionary.Type.HOT, BiomeDictionary.Type.WET, BiomeDictionary.Type.OVERWORLD);
    registerBiome(PLAINS_PLATEAU = k("plains_plateau"), (int) ConfigManager.PLAINS_PLATEAU.weight(), BiomeManager.BiomeType.COOL, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.OVERWORLD);
    ...
    registerBiome(ROLLING_HILLS = k("rolling_hills"), (int) ConfigManager.ROLLING_HILLS.weight(), BiomeManager.BiomeType.COOL, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.OVERWORLD);
    registerBiome(SNOWY_CONIFEROUS_FOREST = k("snowy_coniferous_forest"), (int) ConfigManager.SNOWY_CONIFEROUS_FOREST.weight(), BiomeManager.BiomeType.COOL, BiomeDictionary.Type.COLD, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.OVERWORLD);
    ...
    registerBiome(WOODLANDS = k("woodlands"), (int) ConfigManager.WOODLANDS.weight(), BiomeManager.BiomeType.COOL, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.OVERWORLD);
